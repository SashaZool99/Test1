...
Процедура ОбновитьДанныеТаблицыЗначений(ТЗ, Обработать = Ложь)
	...
	Для Каждого Колонка Из ТЗ.Колонки Цикл 
		...
		УдалитьТипNullИзОписанияТипа(ТипЗначенияКолонки);
...
Процедура УдалитьТипNullИзОписанияТипа(ТипЗначенияКолонки)
...
// ++ UFG
&НаКлиенте
Процедура ЗагрузкаЗначениеИзСтрокиВнутрСтрокой(Команда)
	НачатьЗагрузкуИзСтрокиВнутрСтрокой();
	ОбновитьЭлементыУправления();
КонецПроцедуры 

&НаКлиенте
Процедура НачатьЗагрузкуИзСтрокиВнутрСтрокой()
...
Процедура ПослеВводаСтрокиИзСтрокиВнутрСтрокой(Результат, ДополнительныеПараметры) Экспорт
	...
	ОбновитьДанныеТаблицыЗначений(ЗначениеИзСтрокиВнутр(Результат));
